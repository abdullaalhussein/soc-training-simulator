...
const SUB_LABELS: [number, number, string][] = [
  [1,   1629, "REAL-TIME MONITORING"],
  [1632, 1850, "TRAINEE CHAT → TRAINER"],
  [1853, 2444, "TRAINER REPLY → TRAINEE"],
  [2445, 3035, "BROADCAST ALERT"],
  [3037, 3362, "LIVE ACTIVITY LOG"],
];

/**
 * Act 4: Split-screen view — trainer on left, trainee on right,
 * with timed sub-overlays describing the real-time interaction.
 * 3362 frames (112.1s at 30fps).
 */
